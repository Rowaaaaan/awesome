...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("rofi -combi-modi window,drun,run -show combi -modi combi",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "Rofi launcher", group = "hotkeys"}),
    awful.key({ modkey }, "c",
    function ()
        awful.spawn(string.format("rofi -show calc -modi calc -no-show-match -no-sort",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
